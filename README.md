...
| **`sectional`** (light gray background for last template)<br/> When used it should be the **last visible template** of a card. | This template does not take parameters<br/> Use `{"sectional":true}` |
